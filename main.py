...
pavouk_max = Pavouk(-500, -500, settings.PAVOUK_MAX_IMAGE, settings.PAVOUK_MAX_ANGRY_IMAGE, 6)
pavouk_tery = Pavouk(-500, settings.SCREEN_HEIGHT + 500, settings.PAVOUK_TERY_IMAGE, settings.PAVOUK_TERY_ANGRY_IMAGE, 6)
pavouk_niky = Pavouk(settings.SCREEN_WIDTH + 500, -500, settings.PAVOUK_NIKY_IMAGE, settings.PAVOUK_NIKY_ANGRY_IMAGE, 6)
pavouk_eda = Pavouk(settings.SCREEN_WIDTH + 500, settings.SCREEN_HEIGHT + 500, settings.PAVOUK_EDA_IMAGE, settings.PAVOUK_EDA_ANGRY_IMAGE, 6)
pavouk_hana = Pavouk(settings.SCREEN_WIDTH + 500, settings.SCREEN_HEIGHT + 500, settings.PAVOUK_HANA_IMAGE, settings.PAVOUK_HANA_ANGRY_IMAGE, 6)

pavouk_group = pygame.sprite.Group()

player = Player(settings.SCREEN_WIDTH // 2, settings.SCREEN_HEIGHT // 2, settings.PLAYER_IMAGE, 10)
